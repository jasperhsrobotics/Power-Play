...
@Autonomous
public class AutonomousTestBlueRight extends LinearOpMode {
    OpenCvCamera camera;
    ...
    public void runOpMode()
    {
        ...
        TrajectorySequence goToCone = drive.trajectorySequenceBuilder(new Pose2d(-38, 60, Math.toRadians(270)))
...
*/
        //drive.followTrajectory(beginToCone);

        drive.followTrajectorySequence(goToCone);
