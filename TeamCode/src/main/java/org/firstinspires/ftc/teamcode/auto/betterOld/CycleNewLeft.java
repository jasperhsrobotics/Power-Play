...
@Autonomous
public class CycleNewLeft extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectorySequence ree = drive.trajectorySequenceBuilder(new Pose2d(-34, 62, Math.toRadians(270)))
                ...
                */
                ...
                // drop first cone
                .forward(30)
                .lineToSplineHeading(new Pose2d(-35.3, 10, Math.toRadians(225)))
                .forward(5)
                .waitSeconds(0.4)
                .addTemporalMarker(() -> {
                    claw.setGoingTo(1);
                ...
                .lineToSplineHeading(new Pose2d(-19,10, Math.toRadians(0)))
                .forward(12.5)
                .addTemporalMarker(() -> {
                    claw.setGoingTo(0);
                })
                ...
                // drop second cone
                .back(9)
                .lineToSplineHeading(new Pose2d(-34, 11, Math.toRadians(225)))
                .forward(6.5)
                ...
                // drop third cone
                .back(9)
                .lineToSplineHeading(new Pose2d(-33, 11, Math.toRadians(225)))
                .forward(8)
        ...
        TrajectorySequence strafeRight = drive.trajectorySequenceBuilder(ree.end())
                .lineToSplineHeading(new Pose2d(-58, 15, Math.toRadians(270)))
                .build();
