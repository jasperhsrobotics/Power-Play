...
@Autonomous
public class FancyCycleLeft extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectorySequence ree = drive.trajectorySequenceBuilder(new Pose2d(30, 62, Math.toRadians(270)))
                ...
                */
                ...
                .lineToSplineHeading(new Pose2d(32, 9.5, Math.toRadians(233.2)))
                ...
                .lineToSplineHeading(new Pose2d(50,11, Math.toRadians(0)))
                .addTemporalMarker(() -> {
                    ElapsedTime time = new ElapsedTime();
                    time.reset();
                    time.startTime();
                    while (claw.distanceCentimeters() > 3.1 && time.seconds() < 1.4) {
                ...
                // Dropping 2nd cone
                //.back(9)
                .lineToSplineHeading(new Pose2d(31.5, 8, Math.toRadians(240)))
                .setVelConstraint(new TrajectoryVelocityConstraint() {
                    @Override
                    public double get(double v, @NonNull Pose2d pose2d, @NonNull Pose2d pose2d1, @NonNull Pose2d pose2d2) {
                        return 15;
                ...
                // Dropping 3rd cone
                //.back(9)
                .lineToSplineHeading(new Pose2d(32, 8, Math.toRadians(240)))
                .setVelConstraint(new TrajectoryVelocityConstraint() {
                    @Override
                    public double get(double v, @NonNull Pose2d pose2d, @NonNull Pose2d pose2d1, @NonNull Pose2d pose2d2) {
                        return 15;
